...
inline fun <E, T : Iterable<E>> IterableContains.Builder<E, T, InAnyOrderOnlySearchBehaviour>.value(expected: E): AssertionPlant<T>
    = values(expected)
 ...
 */
@Suppress("NOTHING_TO_INLINE")
inline fun <E : Any, T : Iterable<E>> IterableContains.Builder<E, T, InAnyOrderOnlySearchBehaviour>.entry(noinline assertionCreator: Assert<E>.() -> Unit): AssertionPlant<T>
